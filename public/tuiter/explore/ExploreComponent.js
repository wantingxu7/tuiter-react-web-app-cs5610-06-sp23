...
const ExploreComponent = (haveBar) => {
    ...
    return (`
        ...
        <div class="wd-search-bar">
                    ...
                    <div class="wd-tab-line" style="display:${haveBar === "0" ? 'none' : ''}">
        ...
        <img src="../../images/SpaceX's-Starship.jpeg"
            style="width:100%; margin-top: ${haveBar === "0" ? '10px' : '0'}">
